...
/** Chat de recomendação na Delivery: Cloud Function + secret OPENAI_API_KEY (sem chave no bundle). */
export type { RestaurantRecommendation } from './recommendRestaurantsAiCallable';
export { recommendRestaurants } from './recommendRestaurantsAiCallable';